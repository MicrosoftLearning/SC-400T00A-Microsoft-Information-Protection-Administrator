...
1. Connect to the Exchange Online console by entering **admin@WWLxZZZZZZ.onmicrosoft.com** as the username and @lab.CloudCredential(GTLM365Enterprise2019wSPE_E5).AdministrativePassword as the password.
